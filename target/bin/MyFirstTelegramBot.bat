...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="MyFirstTelegramBot" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" com.home.Bot %CMD_LINE_ARGS%
